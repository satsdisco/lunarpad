...
- **DISC-01**: Ideas can have categories or tags for filtering
- **DISC-02**: Search across idea titles and descriptions

### Engagement

- **ENGM-01**: Notifications when someone joins your idea's team
- **ENGM-02**: Activity feed showing recent idea activity across The Foyer
...
| Feature | Reason |
|---------|--------|
| Role-based teams | Simplicity first, just a join list |
| Approval-based joining | Anyone can join freely |
| Categories or tags | Lightweight, title + description only |
